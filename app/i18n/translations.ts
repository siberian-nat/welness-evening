...
const ru: Dictionary = {
  ...
  hero: {
    eyebrow: "Амстердам / 18 июля / мест немного",
    ...
    date: "18 июля 2026, суббота (дата предварительная, подтвердим скоро)",
    time: "17:00-20:00",
  ...
  reserve: {
    ...
    copy: "Если 18 июля звучит как вечер, который нужен телу и голове, оставь заявку.",
    assurances: [
    ...
    cta: "Оставить заявку",
    cantMakeIt: "Не можешь 18 июля? Напиши — позову на следующую встречу",
  },
  faq: {
    eyebrow: "Вопросы",
...
const en: Dictionary = {
  ...
  hero: {
    eyebrow: "Amsterdam / July 18 / limited spots",
    title: "Wellness Evening Amsterdam",
    ...
    date: "July 18, 2026, Saturday (date tentative, to be confirmed soon)",
    time: "17:00-20:00",
    location: "Stretch & Fold studio Amsterdam",
  ...
  reserve: {
    ...
    copy: "If July 18 sounds like an evening your body and mind need, leave a request.",
    assurances: [
    ...
    cta: "Send a request",
    cantMakeIt: "Can't make July 18? Message me — I'll invite you to the next one",
  },
  faq: {
    eyebrow: "Questions",
