...
const schedule = [
  ["17:00", "Сбор гостей", "Чай, знакомство, полотенца и мягкое переключение из городского темпа."],
  ["17:20", "Стретчинг", "Лёгкое движение, дыхание и расслабление всего тела."],
  ["18:05", "Карты и шейк", "Дегустация Ketology, карты и разговоры в камерном кругу."],
  ["18:35", "Сауна и бассейн", "Приватная сауна 50 минут, вода, тепло и восстановление."],
  ["19:35", "Вино, подарки и финал", "Свободное общение, подарочные мешочки и спокойное завершение."],
  ["20:00", "Завершение", "Уходим легче, теплее и с ощущением маленького отпуска."],
];
...
export default function Home() {
  const eventJsonLd = {
    ...
    endDate: "2026-06-27T20:00:00+02:00",
    ...
    <main>
      ...
      <section className="program section" id="program">
        <div className="section__inner program__grid">
          <div className="program__sticky" data-reveal>
            ...
            <p>
              Начало в 17:00. Сначала мягко разогреваем тело, затем уходим в
      ...
      <footer className="footer">
        <div className="section__inner footer__inner">
          ...
          <p>Амстердам / 27.06.2026 / 17:00 / 10 мест</p>
        </div>
      </footer>
